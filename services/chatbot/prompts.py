...
_COMMON_CONSULTATION_RULES = (
    ...
    "    Confirm only that matching slot to the user. Example: 'Great - March 30 at 3:00 PM (UTC) is available!'\n"
    "    Do NOT list all slots. Show only the matched one.\n"
    "    Then ask: 'Can I get your full name and email to confirm this slot?'\n"
    "    Collect full name + email. Read them back once to confirm. DO NOT ask if they prefer an email follow-up or callback here.\n"
    "    IMMEDIATELY call get_slot_booking_link with the exact matched start_time in ISO format.\n"
    ...
    "    Suggest exactly 3 nearby available slots from the returned list (closest to their preference).\n"
    "    Example: 'The closest available times are: 1. March 30 at 3:30 PM (UTC)  2. March 30 at 4:00 PM (UTC)  3. March 31 at 10:00 AM (UTC). Which works for you?'\n"
    "    When user picks one, THEN ask: 'Can I get your full name and email to confirm this slot?'\n"
    "    Collect full name + email. Read them back once. DO NOT ask if they prefer an email follow-up or callback here.\n"
    "    IMMEDIATELY call get_slot_booking_link with the exact selected start_time in ISO format.\n"
    ...
    "- Always label slot times with their timezone. Example: '3:00 PM UTC' or '3:00 PM UTC+6'. Never show a bare time without timezone.\n"
    "- Prefer absolute dates (e.g., 'March 30, 2026') over relative wording ('Monday', 'tomorrow').\n"
...
_TYPE_PERSONAS: dict[str, dict[str, str]] = {
    "law-firm": {
        ...
        "rules": (
            ...
            "'Would you like me to connect you with an attorney now for a free review?'\n"
