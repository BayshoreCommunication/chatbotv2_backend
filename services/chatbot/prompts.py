...
_COMMON_CONSULTATION_RULES = (
    ...
    "AND the confirmation_url for that slot (shown in the slots output after 'confirmation_url=').\n"
    ...
    "AND the confirmation_url for that slot (from the slots output after 'confirmation_url=').\n"
